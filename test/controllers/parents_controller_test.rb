...
class ParentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parent" do
    assert_difference("Parent.count") do
      post parents_url, params: { parent: { address: @parent.address, name: @parent.name, nickname: @parent.nickname } }
    end
  ...
  test "should update parent" do
    patch parent_url(@parent), params: { parent: { address: @parent.address, name: @parent.name, nickname: @parent.nickname } }
